...
const publications = [
  ...
  },
  {
    ...
    authors: ["Carlos Eduardo Martins", "Robert Johnson", "James Wilson", "Ana Silva"],
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-8">
        ...
        <TabsContent value="citations" className="mt-0">
          <div className="bg-secondary p-8 rounded-lg text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">Dados de Citação em Processamento</h3>
            <p className="text-muted-foreground mb-4">
              Os dados detalhados de citações estão sendo processados e estarão disponíveis em breve.
            </p>
            <div className="max-w-md mx-auto">
              <p className="text-sm text-muted-foreground mb-2">
                Total de citações: <span className="font-semibold">{profile.citationsCount}</span>
              </p>
            ...
            {coauthors.map((coauthor, index) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {coauthor.count} {coauthor.count === 1 ? "publicação" : "publicações"} em comum
                  </p>
                </div>
