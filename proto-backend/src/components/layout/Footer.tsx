      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm">
              Facilitando o acompanhamento de informações acadêmicas através do
              ORCID.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/monitor" className="text-sm hover:text-primary">
                  Monitoramento
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-border/50 text-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} Projeto Orquídea. Todos os
            direitos reservados.
          </p>
        </div>
      </div>
